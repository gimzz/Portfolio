...
<template>
  <div
    class="inline-flex items-center gap-2 backdrop-blur-sm py-2 px-3 bg-blue-500/20 border border-blue-500/30 rounded-full ml-4"
  >
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512" class="text-blue-400">
    ...
    <span class="text-blue-200 text-xs font-medium">{{ label }}</span>
  </div>
</template>
